...
import org.jboss.seam.render.template.resolver.StringTemplateResource;
 ...
 */
public class StringTemplateResourceTest extends RenderTestBase
{
   @Inject
   ...
   @Test
   public void testStringTemplateResolverFunctionsNormally() throws Exception
   {
